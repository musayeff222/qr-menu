...
const BASE_AZ: Record<string, string> = {
  dashboard: "Panel",
  settings: "Ayarlar",
  settings_tab_general: "Ümumi",
  settings_tab_social: "Sosial",
  settings_tab_hours: "İş saatları",
  settings_tab_contact: "Əlaqə",
  settings_tab_design: "Dizayn",
  settings_tab_media: "Media slider",
  settings_tab_qr: "QR kod",
  ...
  panel_profile_hint: "Ad, sluq, ümumi məlumat",
...
const BASE_EN: Record<string, string> = {
  ...
  settings_tab_hours: "Opening hours",
  settings_tab_contact: "Contact",
  settings_tab_design: "Design",
  settings_tab_media: "Header media",
  settings_tab_qr: "QR code",
  ...
  panel_profile_hint: "Name, slug, basic info",
...
const BASE_RU: Record<string, string> = {
  ...
  settings_tab_social: "Соцсети",
  settings_tab_hours: "Часы работы",
  settings_tab_contact: "Контакты",
  settings_tab_design: "Оформление",
  settings_tab_media: "Медиа шапки",
  settings_tab_qr: "QR-код",
  ...
  panel_profile_hint: "Название, слаг, основное",
...
const BASE_TR: Record<string, string> = {
  ...
  settings_tab_social: "Sosyal",
  settings_tab_hours: "Çalışma saatleri",
  settings_tab_contact: "İletişim",
  settings_tab_design: "Tasarım",
  settings_tab_media: "Üst medya",
  settings_tab_qr: "QR kod",
  restaurants: "Restoranlar",
  ...
  panel_profile: "Profil",
  panel_profile_hint: "Ad, slug, genel bilgi",
...
const EXT_EN: Record<string, string> = {
  ...
  plan_list_current_badge: "Current active plan",
  plan_comparison_title: "Plan comparison",
  plan_comparison_hint: "Choose a plan below and send a request to change your subscription.",
  plan_comparison_submit: "Send change request",
  plan_vip_active_locked: "VIP is already active — cannot select here.",
  ...
  landing_hero_display_sub:
    "Move from outdated paper menus to a premium digital experience.",
  ...
  landing_whatsapp_support_tooltip: "Message us on WhatsApp for help and support",
  landing_whatsapp_support_prefill: "Hello, I need help with QRMenu.",
...
const EXT_AZ: Record<string, string> = {
  ...
  landing_sales_title: "Daha çox sifariş — masa skanlarını WhatsApp sifarişinə çevirin",
  landing_sales_sub:
  ...
  plan_list_current_badge: "Hazırda aktiv plan",
  plan_comparison_title: "Plan müqayisəsi",
  plan_comparison_hint: "Aşağıdan plan seçin və abunə dəyişikliyi üçün sorğu göndərin.",
  plan_comparison_submit: "Dəyişiklik sorğusu göndər",
  plan_vip_active_locked: "VIP hazırda aktivdir — bu planda yenidən seçim mümkün deyil.",
  ...
  landing_hero_display_sub: "Köhnəlmiş kağız menyulardan premium rəqəmsal təcrübəyə keçin.",
  ...
  landing_whatsapp_support_tooltip: "Yardım və dəstək üçün WhatsApp üzərindən yazın",
  landing_whatsapp_support_prefill: "Salam, QRMenu ilə bağlı dəstək lazımdır.",
...
const EXT_RU: Record<string, string> = {
  ...
  plan_unlimited_badge: "Без лимита",
  ...
  plan_list_current_badge: "Текущий активный план",
  plan_comparison_title: "Сравнение планов",
  plan_comparison_hint: "Выберите план ниже и отправьте запрос на смену подписки.",
  plan_comparison_submit: "Отправить запрос на смену",
  plan_vip_active_locked: "VIP уже активен — нельзя выбрать снова.",
  ...
  landing_hero_display_sub:
    "От устаревших бумажных меню к премиальному цифровому опыту.",
  ...
  landing_whatsapp_support_tooltip: "Напишите нам в WhatsApp для помощи и поддержки",
  landing_whatsapp_support_prefill: "Здравствуйте, нужна помощь по QRMenu.",
...
const EXT_TR: Record<string, string> = {
  ...
  plan_upgrade_modal_title: "Plan seçin",
  plan_list_current_badge: "Şu an aktif plan",
  plan_comparison_title: "Plan karşılaştırması",
  plan_comparison_hint: "Aşağıdan plan seçin ve abonelik değişikliği için talep gönderin.",
  plan_comparison_submit: "Değişiklik talebi gönder",
  plan_vip_active_locked: "VIP zaten aktif — burada yeniden seçilemez.",
  ...
  landing_hero_display_sub: "Eski kağıt menülerden premium dijital deneyime geçin.",
  ...
  landing_whatsapp_support_tooltip: "Yardım ve destek için WhatsApp üzerinden yazın",
  landing_whatsapp_support_prefill: "Merhaba, QRMenu desteğe ihtiyacım var.",
